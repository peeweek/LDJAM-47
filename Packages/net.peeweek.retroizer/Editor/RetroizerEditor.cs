...
namespace Retroizer
{
    ...
    public class RetroizerEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            AddProperty("m_Quality");
            AddProperty("OverscanMaskHardness");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Properties["m_Quality"], false);
            EditorGUILayout.PropertyField(m_Properties["OverscanMaskHardness"], false);
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                (serializedObject.targetObject as Retroizer).UpdateMaterial();
            }
        }
    }
